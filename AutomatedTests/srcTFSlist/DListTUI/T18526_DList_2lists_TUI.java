...
public class T18526_DList_2lists_TUI
{
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    try
	    {
		    ...
		    WebDriverLogin.resetDListAll(wd, "900049", "900149");
	    	WebDriverLogin.enableBoxRange(wd, "900005", "900149");
	    	WebDriverLogin.resetMessages(wd, "900005", "900005");
	    	WebDriverLogin.resetMessages(wd, "900049", "900149");
	    	//
	    	//Test Case 18526:DLIST - From Phone - Send message to 10 and 100 sized DLists
	    	WebDriverLogin.searchBoxRange(wd, "900005", "900005", 3000);
		    //create dlists
		    String DListName = "DListAdd100";
		    String DListName2 = "DListAdd10";
		    ...
		    try
		    {
	            ...
	            wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxDdlDlistNumber")).sendKeys("4");
	            wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxRbAddInternal")).click();
	            WebDriverLogin.waitT(wd, 2000);
	            wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxTxtStartRange")).sendKeys("900040");
	            wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxTxtEndRange")).sendKeys("900049");
	            wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxLbSchInternal")).click();
	            WebDriverLogin.waitT(wd, 2000);
	    ...
	    try
	    {
	        String[] folderList = {"DList", "TestSuite", "DListSetup", "3", "T18526_DList_MSG2lists"};
        ...
        {
	        wd = WebDriverLogin.getWebAdmin();
	        result += checkStatus(wd, "900049");
	        result += checkStatus(wd, "900050");
	        result += checkStatus(wd, "900149");
	        wd.quit();
			wd = null;
		}
		catch(Exception ex)
