...
public class T15163_Search_FN
{
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    try
	    {
			...
			wd.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);WebDriverLogin.resetDListAll(wd, "900005", "900005");
	    	WebDriverLogin.enableBoxRange(wd, "900005", "900005");
	    	WebDriverLogin.searchBoxRange(wd, "900005", "900005", 3000);
		    //create dlist
		    String DListName = "DListAddFN";
	        ...
	        if(testSearchOptions(wd, "Remove", "Other") != -10)        
	        	result += -10;
	        result += testSearchOptions(wd, "R", "");
	        result += testSearchOptions(wd, "Ran", "");
	        result += testSearchOptions(wd, "Ra", "Orton");
	        result += testSearchOptions(wd, "Randy", "Ort");
	        result += testSearchOptions(wd, "Randy", "");
