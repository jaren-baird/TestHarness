...
public class T18509_DList_EditNumber
{
	private static int result = 9;
	private static int Exception = -2;
	public static boolean JITCflag = true;
	private static ChromeDriver wd = null;
	//T18509_DList_EditNumber-t0
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    if(wd.findElement(By.tagName("html")).getText().contains(DListName))
	    {
	    	...
	    	value = wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxRptLocalList_ctl01_uxLblLocalDlistNumber")).getText();
	    	WebDriverLogin.waitT(wd, 2500);
	    	...
	    	try
		    {
		    	wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxRptCurrentMembers_ctl01_uxChkMemberItem")).click();
			  	...
			  	{
		            wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxDdlDlistNumber")).sendKeys(EditDListNum);
			  	}
		  	   	else
		  	   		result += -100;
	    ...
	    try
	    {
	    	wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmDistLists_ucVmDistributionLists_uxRptCurrentMembers_ctl01_uxChkMemberItem")).click();
	  	   	...
	  	   	else if(value.contains(EditDListNum))
		  	{
