...
public class T19437_FutureDelivery
{
	...
	//T19437_FutureDelivery-t0
	//Test Case 19437:TUI - Mark the new message with Future Delivery
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    try
		{
	    	String[] folderList = {"DList", "TestSuite", "TUI", "TUIvm", "T19437_FutureDelivery"};
		...
		try
    	{
			...
			WebDriverLogin.searchBoxRange(wd, "900005", "900005");
		  	...
		  	{
	    		result += -10;
	    		System.out.println("future delivery failed");
	    	}
		  	wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxLbBoxStatusClose")).click();
		  	WebDriverLogin.waitT(wd, 2500);
