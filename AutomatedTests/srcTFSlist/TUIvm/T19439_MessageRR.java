...
public class T19439_MessageRR
{
	...
	//T19439_MessageRR-t0
	//Test Case 19439:TUI - Mark the new message with a Return receipt
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    try
		{
	    	String[] folderList = {"DList", "TestSuite", "TUI", "TUIvm", "T19439_MessageRR"};
	    ...
	    try
		{
	    	String[] folderList = {"DList", "TestSuite", "TUI", "TUIvm", "T19439_ListenRR"};
			wd = WebDriverLogin.getCyara(args);
			result += WebDriverLogin.cyaraFolderSearch(wd, folderList);
	        WebDriverLogin.waitT(wd, 1500);
			if(!wd.findElement(By.tagName("html")).getText().contains("Save & Run")) {
			...
			//
			wd.findElement(By.id("executeButton")).click();
			WebDriverLogin.waitT(wd, 117000);
			String[] para = {"0","true"};
	        result += WebDriverLogin.RunErrorTable(wd, para);
		   	//
			wd.quit();
