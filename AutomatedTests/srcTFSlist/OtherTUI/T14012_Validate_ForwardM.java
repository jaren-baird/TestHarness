...
public class T14012_Validate_ForwardM
{
	...
	//T14012_Validate_ForwardM-t0
	//Test Case 14012:WebAdmin - Messages - Forward message checked by default
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			String[] folderList = {"DList", "TestSuite", "Messaging", "LeaveAMessage", "T14012_Validate_ForwardM"};
