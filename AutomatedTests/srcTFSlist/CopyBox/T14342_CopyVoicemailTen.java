...
public class T14342_CopyVoicemailTen
{
	private static int result = 9;
	private static int Exception = fail();
	public static boolean JITCflag = true;
	private static ChromeDriver wd = null;
	private static String FilePath = WebDriverLogin.getFilePath();
	//T14342_CopyVoicemailTen-t0
	//Test Case 14342
	...
	public static void main(String[] args) throws Exception
	{
        ...
        try
        {
        	...
        	WebDriverLogin.resetBoxAll(wd, "900007", "900017");
		    ...
		    for(int i = 900007; i < 900018; i++)
		    {
		        WebDriverLogin.searchBoxRange(wd, Integer.toString(i), Integer.toString(i), 2500);
