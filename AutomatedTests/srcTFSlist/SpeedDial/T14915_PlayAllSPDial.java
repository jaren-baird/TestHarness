...
public class T14915_PlayAllSPDial
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
		    ...
		    WebDriverLogin.waitT(wd, 2400);
	        wd.findElement(By.id("__tab_ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmCallOptions_Vm")).click();
		    WebDriverLogin.waitT(wd, 2500);
		    for(int i = 1; i < 10; i++)
		    {
			    wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmCallOptions_Vm_ucVmCallOptions_VM_uxTxtProgSpeedDial_Key")).sendKeys(""+i);
		...
		try
		{
	        String[] folderList = {"DList", "TestSuite", "Other", "SpeedDial", "T14915_PlayAllSPDial"};
