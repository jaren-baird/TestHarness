...
public class T14916_PlayChngdSPD
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
		    ...
		    wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmCallOptions_Vm_ucVmCallOptions_VM_uxTxtProgSpeedDial_Number")).sendKeys("900005");
		...
		try
		{
	        String[] folderList = {"DList", "TestSuite", "Other", "SpeedDial", "T14916_PlayChngdSPD"};
