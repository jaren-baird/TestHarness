...
public class T18741_Teacher_HW_upto8
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		//setup 899990
        //setup All 1-8 homework
		try
		{
	        String[] folderList = {"DList", "TestSuite", "Teacher", "2", "T18741_HW_upto8"};
	        ...
	        WebDriverLogin.waitT(wd, 295000);
	        String[] para = {"0","true"};
