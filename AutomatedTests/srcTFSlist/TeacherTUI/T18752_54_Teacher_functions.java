...
public class T18752_54_Teacher_functions
{
	...
	//T18752_54_Teacher_functions-t0
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
	        ...
	        WebDriverLogin.waitT(wd, 187000);
	        String[] para = {"0","true"};
		...
		try
		{
	        //setup T18752_54_Teacher_functions
	        String[] folderList = {"DList", "TestSuite", "Teacher", "2", "T18752_54_functions"};
			wd = WebDriverLogin.getCyara(args);
			result += WebDriverLogin.cyaraFolderSearch(wd, folderList);
	        WebDriverLogin.waitT(wd, 1500);
	        if(!wd.findElement(By.tagName("html")).getText().contains("Save & Run")) {
		...
		try
		{
	        //run T18755_Teacher_func
	        String[] folderList = {"DList", "TestSuite", "Teacher", "2", "T18755_func"};
			wd = WebDriverLogin.getCyara(args);
			result += WebDriverLogin.cyaraFolderSearch(wd, folderList);
	        WebDriverLogin.waitT(wd, 1500);
	        if(!wd.findElement(By.tagName("html")).getText().contains("Save & Run")) {
