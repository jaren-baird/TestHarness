...
public class T14003_ValidateMNM
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
		    ...
		    wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerVoiceMailProps_uxTpVmMessages_ucVmMessages_uxTxtMessageParams_MaxNumMessages")).sendKeys("99999");
	        ...
	        if(value.contains("9999") && value.length() == 4)
	        	result = 0;
	        else
	        	result += -10;
