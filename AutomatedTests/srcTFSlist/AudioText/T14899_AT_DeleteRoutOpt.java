...
public class T14899_AT_DeleteRoutOpt 
{
	...
	public static void main(String[] args) throws Exception
	{
        ...
        try
        {
	        ...
	        wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerAutoAttendantProps_uxTpCallOptions_ucAttenCallOptions_AA_uxTxtRoutingOptions_Key")).sendKeys("4");
	        ...
	        wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxTabContainerAutoAttendantProps_uxTpCallOptions_ucAttenCallOptions_AA_uxTxtRoutingOptions_Number")).sendKeys("900005");
        ...
        try
        {
	        String[] folderList = {"DList", "TestSuite", "Other", "AudioText", "T14899_DeleteRoutOpts"};
