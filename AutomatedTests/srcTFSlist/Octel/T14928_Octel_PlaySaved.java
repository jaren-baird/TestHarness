...
public class T14928_Octel_PlaySaved 
{
	private static int result = 9;
	private static int Exception = -2;
	public static boolean JITCflag = true;
	private static ChromeDriver wd = null;
	//Octel_T14928_PlaySaved-t0
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
	    	String[] folderList = {"DList", "TestSuite", "TUI", "OctelTS", "Leave_message"};
		...
		try
		{
	    	String[] folderList = {"DList", "TestSuite", "TUI", "OctelTS", "Octel_T14928_PlaySaved"};
			wd = WebDriverLogin.getCyara(args);
			result += WebDriverLogin.cyaraFolderSearch(wd, folderList);
	        WebDriverLogin.waitT(wd, 1500);
	        if(!wd.findElement(By.tagName("html")).getText().contains("Save & Run")) {
		...
		try
		{
	        ...
	        String value = wd.findElement(By.id("ctl00_uxCphContent_ucBoxes_uxLblVoiceMsg_Saved_Value")).getText();
	        if(!value.contains("1"))
	        {
		    	result += -10;
	        }
