...
public class Test_MSG_COSvcs_EMA_off
{
	...
	public static void main(String[] args) throws Exception
	{
        ...
        if(!wd.findElement(By.tagName("html")).getText().contains("VM_MSG_COSvcs_EMA_off")) {
            System.out.println(" ");
        }
        wd.findElement(By.linkText("VM_MSG_COSvcs_EMA_off")).click();
