...
public class Test_MSG_AMPMD_off_crtmsg
{
	...
	public static void main(String[] args) throws Exception
	{
        ...
        if (!wd.findElement(By.tagName("html")).getText().contains("VM_MSG_AMPMD_off_CRTMSG")) {
            System.out.println(" ");
        }


        wd.findElement(By.linkText("VM_MSG_AMPMD_off_CRTMSG")).click();
